...
public class BzeroTest extends TestCase {
    ...
    public void testEmpty() {
        ...
        for (int i=1;i<100;i++) {
            ...
            com.onionnetworks.util.Util.bzero(b,off,len);
            assertTrue("Empty: off="+off+",len="+len,checkArray(b2,b,off,len));
        }
    }
    ...
    public void testFilled() {
        ...
        for (int i=1;i<100;i++) {
            ...
            int len = rand.nextInt(b.length-off);
            com.onionnetworks.util.Util.bzero(b,off,len);
            assertTrue("Filled : off="+off+",len="+len,checkArray(b2,b,off,len));
        }
    }
