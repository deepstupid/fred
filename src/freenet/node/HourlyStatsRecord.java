...
public class HourlyStatsRecord {
	...
	private static class StatsLine {
		final TrivialRunningAverage chkLocalSuccess;
		final TrivialRunningAverage chkRemoteSuccess;
		final TrivialRunningAverage chkFailure;
		final TrivialRunningAverage sskLocalSuccess;
		final TrivialRunningAverage sskRemoteSuccess;
		final TrivialRunningAverage sskFailure;
		final TrivialRunningAverage locDiffCHK;
		final TrivialRunningAverage locDiffSSK;
